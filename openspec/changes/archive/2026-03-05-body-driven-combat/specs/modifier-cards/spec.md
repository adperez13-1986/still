...
- **THEN** Still's deck contains exactly: 3x Boost (Amplify, +1 Heat, +50% output to one slot), 2x Emergency Strike (Override, +2 Heat, any slot deals 8 damage), 2x Coolant Flush (Cooling, −3 Heat), 1x Diagnostics (System, +1 Heat, draw 2 modifier cards)
...
- **THEN** they draw modifier cards from the draw pile up to hand size (default: 4)
