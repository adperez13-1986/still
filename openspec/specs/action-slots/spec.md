...
The unified action slot system: 5 slots arranged as 2 linked pairs + 1 solo. Every combat action (damage, block, heal, utility) occupies the same type of slot. Pushing a slot costs strain. Pushing both slots in a pair activates a link synergy based on their type combination.
