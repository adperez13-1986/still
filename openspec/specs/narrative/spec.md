...
Yanah and Yuri SHALL be unlockable companion modifier cards — system cards that are added to the starting modifier deck when unlocked. They are adapted from the old card-as-action format to the modifier card format.
...
- **THEN** Yanah and Yuri companion modifier cards are permanently unlocked and added to the starting deck of all future runs
