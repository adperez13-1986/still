...
When a room collapses, the player SHALL be notified with the room type that was lost.

#### Scenario: Room collapses
- **WHEN** a room collapses
- **THEN** the room visually changes to rubble on the map and a brief notification is shown identifying the room type (e.g., "A Shop room has collapsed!")
