...
Still SHALL have three core stats: Health (maximum and current), Heat (integer, minimum 0, no maximum — the central combat resource), and Block (resets each turn, absorbs incoming damage before health). Energy is removed as a stat.
